		...
		<a-row class="matchTeamBox">
			...
			<a-col :span="8" class="matchCenter">
				<div class="centerTime">
					<div>{{ $filters.filterDate(matchTeam.confrontationDate) }}</div>
					<div class="typeStyle">
						<div v-if="matchTeam.type === 1">{{ $t('default.63') }}</div>
			...
			<a-col :span="8" class="matchTeamLeftBox">
				<div class="awayTeamState">
					<div v-if="matchTeam.visitingManageStatus === 0" class="teamStateStyle">{{ $t('default.60') }}</div>
					<div v-if="matchTeam.visitingManageStatus === 1" class="teamStateStyle">{{ $t('default.287') }}</div>
